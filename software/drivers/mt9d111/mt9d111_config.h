...
const Register reg_vals_qvga_30fps[] =
{
    ...
    {MT9D111_REG_PAGE_REGISTER                                          , MT9D111_REG_PAGE_1,   MT9D111_REG_PAGE_1},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS                       , MT9D111_REG_PAGE_1,   0x2735},    // MODE_CROP_X0_A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA                          , MT9D111_REG_PAGE_1,   0x0000},    // MODE_CROP_X0_A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS                       , MT9D111_REG_PAGE_1,   0x2737},    // MODE_CROP_X1_A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA                          , MT9D111_REG_PAGE_1,   1600},      // MODE_CROP_X1_A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS                       , MT9D111_REG_PAGE_1,   0x2739},    // MODE_CROP_Y0_A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA                          , MT9D111_REG_PAGE_1,   0x0000},    // MODE_CROP_Y0_A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS                       , MT9D111_REG_PAGE_1,   0x273B},    // MODE_CROP_Y1_A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA                          , MT9D111_REG_PAGE_1,   1200},      // MODE_CROP_Y1_A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS                       , MT9D111_REG_PAGE_1,   0xA103},    // SEQ_CMD, Do capture
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA                          , MT9D111_REG_PAGE_1,   0x0005},

    {MT9D111_REG_PAGE_REGISTER                                          , MT9D111_REG_PAGE_0,   MT9D111_REG_PAGE_0},
};

/**
 * \brief 800x600 at 30 FPS (preview mode) and 15 FPS (capture mode).
 *
 *      - XCLK = 10 MHz
 *      - MCLK = 80 MHz
 *      - Preview mode = 800x600 @ 30 FPS
 *      - Capture mode = 800x600 @ 15 FPS
 *      .
 *
 * \note Values obtained with the Register Wizard.
 */
const Register reg_vals_800x600[] =
{
    // Set register page
    {MT9D111_REG_PAGE_REGISTER,                         MT9D111_REG_PAGE_0,     MT9D111_REG_PAGE_0},

    {MT9D111_REG_HORIZONTAL_BLANKING_B,                 MT9D111_REG_PAGE_0,     0x0222},
    {MT9D111_REG_VERTICAL_BLANKING_B,                   MT9D111_REG_PAGE_0,     0x001E},
    {MT9D111_REG_HORIZONTAL_BLANKING_A,                 MT9D111_REG_PAGE_0,     0x010D},
    {MT9D111_REG_VERTICAL_BLANKING_A,                   MT9D111_REG_PAGE_0,     0x000B},
    {MT9D111_REG_READ_MODE_B,                           MT9D111_REG_PAGE_0,     0x0300},
    {MT9D111_REG_READ_MODE_A,                           MT9D111_REG_PAGE_0,     0x8400},
    {MT9D111_REG_PLL_CONTROL_1,                         MT9D111_REG_PAGE_0,     0x1000},
    {MT9D111_REG_PLL_CONTROL_2,                         MT9D111_REG_PAGE_0,     0x0500},
    {MT9D111_REG_CLOCK_CONTROL,                         MT9D111_REG_PAGE_0,     0xA000},
    {MT9D111_REG_CLOCK_CONTROL,                         MT9D111_REG_PAGE_0,     0x2000},

    // Set register page
    {MT9D111_REG_PAGE_REGISTER,                         MT9D111_REG_PAGE_0,     MT9D111_REG_PAGE_1},

    // Output Width A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2703},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     800},

    // Output Height A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2705},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     600},

    // Output Width B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2707},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     800},

    // Output Height B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2709},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     600},

    // Mode Config.
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x270B},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x0030},

    // Row Start A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x270F},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     28},

    // Column Start A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2711},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     60},

    // Row Height A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2713},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     1200},

    // Column Width A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2715},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     1600},

    // Extra Delay A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2717},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x0003},

    // Row Speed A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2719},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x0011},

    // Row Start B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x271B},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     28},

    // Column Start B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x271D},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     60},

    // Row Height B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x271F},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     1200},

    // Column Width B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2721},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     1600},

    // Extra Delay B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2723},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x000E},

    // Row Speed B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2725},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x0011},

    // Crop X0 A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2727},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0},

    // Crop X1 A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2729},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     800},

    // Crop Y0 A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x272B},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0},

    // Crop Y1 A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x272D},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     600},

    // Crop X0 B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2735},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0},

    // Crop X1 B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2737},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     1600},

    // Crop Y0 B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2739},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0},

    // Crop Y1 B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x273B},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     1200},

    // FIFO Config. 1 A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x276D},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0xE0E2},

    // FIFO Config. 2 A
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0xA76F},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x00E1},

    // FIFO Config. 1 B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x2774},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0xE0E1},

    // FIFO Config. 2 B
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0xA776},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x00E1},

    // Max. R12 B (Shutter Delay)
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x20DF},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x01B0},

    // Row Time (MSCLK per)/4
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x20F0},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x0216},

    // R9 Step
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x20FF},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x009A},

    // Search F1 50
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0xA408},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x0024},

    // Search F2 50
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0xA409},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x0026},

    // Search F1 60
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0xA40A},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x001D},

    // Search F2 60
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0xA40B},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x001F},

    // R9 Step 60
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x249A},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x009A},

    // R9 Step 50
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0x24B9},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x00B9},

    // Refresh Sequencer Mode
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_ADDRESS,      MT9D111_REG_PAGE_1,     0xA103},
    {MT9D111_REG_MICROCONTROLLER_VARIABLE_DATA,         MT9D111_REG_PAGE_1,     0x0006},
