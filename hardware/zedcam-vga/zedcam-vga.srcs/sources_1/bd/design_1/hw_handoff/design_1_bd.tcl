...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set B_out_0 [ create_bd_port -dir O -from 3 -to 0 B_out_0 ]
  set G_out_0 [ create_bd_port -dir O -from 3 -to 0 G_out_0 ]
  set R_out_0 [ create_bd_port -dir O -from 3 -to 0 R_out_0 ]
  set data_in_0 [ create_bd_port -dir I -from 7 -to 0 data_in_0 ]
  set hsync_0 [ create_bd_port -dir I hsync_0 ]
  set hsync_1 [ create_bd_port -dir O hsync_1 ]
  ...
  set vsync_1 [ create_bd_port -dir O vsync_1 ]
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {272.822} \
   CONFIG.CLKOUT1_PHASE_ERROR {160.491} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {10} \
   CONFIG.CLKOUT2_JITTER {228.649} \
   CONFIG.CLKOUT2_PHASE_ERROR {160.491} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {25.175} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} \
   CONFIG.CLK_OUT1_PORT {xclk} \
   CONFIG.CLK_OUT2_PORT {vga} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#I2C 0#I2C 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#scl#sda#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_net -net Counter_1_count [get_bd_pins Counter_1/count] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net VGA_0_B_out [get_bd_ports B_out_0] [get_bd_pins VGA_0/B_out]
  connect_bd_net -net VGA_0_G_out [get_bd_ports G_out_0] [get_bd_pins VGA_0/G_out]
  connect_bd_net -net VGA_0_R_out [get_bd_ports R_out_0] [get_bd_pins VGA_0/R_out]
  connect_bd_net -net VGA_0_hsync [get_bd_ports hsync_1] [get_bd_pins VGA_0/hsync]
  connect_bd_net -net VGA_0_video_rdy [get_bd_pins Counter_1/en] [get_bd_pins VGA_0/video_rdy] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net VGA_0_vsync [get_bd_ports vsync_1] [get_bd_pins VGA_0/vsync]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins VGA_0/RGB_in] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net clk_wiz_0_vga [get_bd_pins Counter_1/clk] [get_bd_pins VGA_0/clk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/vga]
  ...
  connect_bd_net -net vsync_0_1 [get_bd_ports vsync_0] [get_bd_pins CSI_RX_0/vsync] [get_bd_pins Counter_0/rst] [get_bd_pins Counter_1/rst]
