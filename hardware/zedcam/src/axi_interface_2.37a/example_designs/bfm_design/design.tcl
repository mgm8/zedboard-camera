...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/axi_interface_v2_37a_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef axi_interface_v2_37a_tb_include_vh_"
	puts $fp "`define axi_interface_v2_37a_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:axi_interface:2.37a]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/axi_interface_v2_37a_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "axi_interface_v2_37a_bfm_${i}"
...
remove_files -quiet -fileset sim_1 axi_interface_v2_37a_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top axi_interface_v2_37a_tb [get_filesets sim_1]
