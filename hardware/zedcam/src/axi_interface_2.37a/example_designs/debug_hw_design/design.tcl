...
proc create_ipi_design { offsetfile design_name } {
	...
	# Copy all address to axi_interface_v2_37a_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/axi_interface_v2_37a_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/axi_interface_v2_37a_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "axi_interface_v2_37a_hw_${i}"
